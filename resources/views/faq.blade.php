...
<!-- Mirrored from code-theme.com/html/findhouses/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Aug 2023 05:52:48 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <div id="wrapper">
        ...
        <section class="headings">
            <div class="text-heading text-center">
                <div class="container">
                    <h1>FAQ’S</h1>
                    <h2><a href="index-2.html">Home </a> &nbsp;/&nbsp; FAQ’S</h2>
                </div>
            </div>
        </section>
