...
<!-- Mirrored from code-theme.com/html/findhouses/properties-half-map-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Aug 2023 05:52:22 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <title>Properties Half Map</title>
    <!-- FAVICON -->
...
<body class="inner-pages the-search half-map-view dashboard-bd homepage-4 agents hp-6 list hd-white">
    ...
    <div id="wrapper">
                    ...
                    <div class="container container-header">
                        ...
                        <div class="right-side d-none d-none d-lg-none d-xl-flex">
                            ...
                            <div class="header-widget">
                                <a href="add-property.html" class="button border">Add Listing<i class="fas fa-laptop-house ml-2 mt-1"></i></a>
                            </div>
                            <!-- Header Widget / End -->
                        </div>
                        <!-- Right Side Content / End -->
        ...
        <section class="properties-right list featured portfolio blog google-map-right">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-6 col-md-12 blog-pots pr-0 fx-google-map-right pr-3">
                            ...
                            <div class="pro-wrapper">
                                <div class="detail-wrapper-body">
                                    <div class="listing-title-bar">
                                        <div class="text-heading text-left">
                                            <p>
                                                <a href="index-2.html"></a> <span>6 Search results</span></p>
                                        </div>
                                        <h3>List View</h3>
                                    </div>
                                </div>
                                <div class="cod-pad single detail-wrapper mr-2 mt-0 d-flex justify-content-md-end align-items-center grid">
                                    ...
                                    <div class="sorting-options">
                                        ...
                                        <a href="properties-half-map-1.html" class="change-view-btn lde"><i class="fa fa-th-large"></i></a>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <div class="row featured portfolio-items">
                            <div class="item col-xl-5 col-lg-12 col-md-12 col-xs-12 landscapes sale pr-0 pb-0">
                                <div class="project-single mb-0 bb-0 ps-1" data-aos="fade-up">
                            ...
                            <!-- homes content -->
                            <div class="col-xl-7 col-lg-12 col-md-12 homes-content pb-0 mb-44" data-aos="fade-up">
                                <!-- homes address -->
                            ...
                            <div class="map-list">
                                <div class="item col-xl-5 col-lg-12 col-md-12 col-xs-12 landscapes sale pr-0 pb-0 my-44 ft">
                                ...
                                <!-- homes content -->
                                <div class="col-xl-7 col-lg-12 col-md-12 homes-content pb-0 my-44 ft mb-44" data-aos="fade-up">
                                    <!-- homes address -->
                                    <h3><a href="single-property-1.html">Real House Luxury Villa</a></h3>
                                    <p class="homes-address mb-3">
                                        <a href="single-property-1.html">
                            ...
                            <div class="map-list">
                                ...
                                <!-- homes content -->
                                <div class="col-xl-7 col-lg-12 col-md-12 homes-content pb-0 my-44 ft" data-aos="fade-up">
                                    <!-- homes address -->
                                    <h3><a href="single-property-1.html">Real House Luxury Villa</a></h3>
                                    <p class="homes-address mb-3">
                                        <a href="single-property-1.html">
                ...
                <nav aria-label="..." class="mt-55 pagi">
                    <ul class="pagination">
