...
<!-- Mirrored from code-theme.com/html/findhouses/properties-half-map-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Aug 2023 05:52:22 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="inner-pages the-search half-map-view dashboard-bd agents hp-6 hd-white">
    <!-- Wrapper -->
    <div id="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 blog-pots pr-0 fx-google-map-right">
                            ...
                            <div class="pro-wrapper">
                                ...
                                <div class="cod-pad single detail-wrapper mr-2 mt-0 d-flex justify-content-md-end align-items-center grid">
                                    ...
                                    <div class="sorting-options">
                                        <a href="properties-half-map-2.html" class="change-view-btn lde"><i class="fa fa-th-list"></i></a>
                        ...
                        <div class="row">
                            ...
                            <div class="item col-xl-6 col-lg-12 col-md-6 col-xs-12 people rent">
                        ...
                        <div class="row">
                            <div class="item col-xl-6 col-lg-12 col-md-6 col-xs-12 people landscapes sale">
                                <div class="project-single" data-aos="fade-up">
                                    <div class="project-inner project-head">
                                        <div class="project-bottom">
                            ...
                            <div class="item col-xl-6 col-lg-12 col-md-6 col-xs-12 people landscapes rent">
                                <div class="project-single" data-aos="fade-up">
                                    <div class="project-inner project-head">
                                        <div class="project-bottom">
                                            <h4><a href="single-property-1.html">View Property</a><span class="category">Real Estate</span></h4>
                        ...
                        <div class="row">
                            <div class="item col-xl-6 col-lg-12 col-md-6 col-xs-12 people sale">
                                <div class="project-single" data-aos="fade-up">
                                    <div class="project-inner project-head">
                                        <div class="project-bottom">
                                            <h4><a href="single-property-1.html">View Property</a><span class="category">Real Estate</span></h4>
                            ...
                            <div class="item col-xl-6 col-lg-12 col-md-6 it2 col-xs-12 web rent x2">
                                <div class="project-single last" data-aos="fade-up">
                                    <div class="project-inner project-head">
                                        <div class="project-bottom">
                                            <h4><a href="single-property-1.html">View Property</a><span class="category">Real Estate</span></h4>
                                        </div>
