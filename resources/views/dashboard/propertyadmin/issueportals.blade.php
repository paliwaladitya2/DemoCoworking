        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h2>Issue Portals</h2>
                    <a href="#" data-toggle="modal" data-target="#loginModal" class="btn btn-primary float-end">Create Issue Portal</a>
                </div> 
                <div class="modal fade " id="loginModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content pl-5 pr-5">
                        <form action="{{ Route('saveportal') }}" method="post">
                            @csrf
