...
<!-- Mirrored from code-theme.com/html/findhouses/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Aug 2023 05:51:26 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="maxw1600 m0a homepage-2 the-search hd-white">
    ...
    <div id="wrapper">
            ...
            <div id="header">
                <div class="container container-header">
                    ...
                    <div class="left-side">
                        <!-- Logo -->
                        <div id="logo">
                            <a href="index-2.html"><img src="images/logo-gray.svg" alt=""></a>
                        </div>
                        <!-- Mobile Navigation -->
        ...
        <!-- START SLIDER -->
        <section class="home17 overlay home-three bg-img3">
            <div class="hero-main">
        ...
        <section class="featured portfolio home18 bg-white-3">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6 col-lg col-xl">
                            <div class="netabout">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cum incidunt architecto soluta laboriosam, perspiciatis, esse.</p>
                            </div>
                            <div class="contactus">
                                <ul>
                                    <li>
...
<!-- Mirrored from code-theme.com/html/findhouses/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Aug 2023 05:51:29 GMT -->
</html>
