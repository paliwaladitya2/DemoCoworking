...
<!-- Mirrored from code-theme.com/html/findhouses/index-24.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Aug 2023 05:51:54 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="homepage-24 homepage-9 hp-6 homepage-1 hd-white">
    ...
    <div id="wrapper">
        ...
        <!-- STAR HEADER IMAGE -->
        <section class="header-image d-flex align-items-center" id="slider">
            <div class="container">
                <div class="row d-flex align-items-center image-24">
                    <div class="col-lg-6 flex-grow-1" data-aos="fade-right">
                        <div class="left wow fadeInLeft">
                            <h1>Find Your dream House</h1>
                            <p>To design is much more than simply to assemble, to order vor even to edit it is to add value and meaning, to illuminate, to simplify, to clarify.</p>
                            <div class="teh-left">
                                <a href="add-property.html" class="btn-white">Get Started</a>
                                <!-- Play Button -->
                    ...
                    <div class="col-lg-6 wow fadeInRight" data-aos="fade-left">
                        <div class="image d-flex justify-content-lg-end justify-content-md-center">
                            <img src="images/bg/slider.png" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="visited-cities bg-white rec-pro">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-6 pr-1" data-aos="fade-up" data-aos-delay="150">
                        <!-- Image Box -->
                        <a href="listing-details.html" class="img-box mi x3 hover-effect">
                    ...
                    <div class="col-lg-2 col-md-6 pr-1" data-aos="fade-up" data-aos-delay="250">
                        <!-- Image Box -->
                        <a href="listing-details.html" class="img-box mi x3 hover-effect">
                    ...
                    <div class="col-lg-2 col-md-6 pr-1" data-aos="fade-up" data-aos-delay="350">
                        <!-- Image Box -->
                    ...
                    <div class="col-lg-2 col-md-6 pr-1" data-aos="fade-up" data-aos-delay="450">
                        <!-- Image Box -->
                    ...
                    <div class="col-lg-2 col-md-6 pr-1" data-aos="fade-up" data-aos-delay="550">
                        <!-- Image Box -->
                    ...
                    <div class="col-lg-2 col-md-6 pr" data-aos="fade-up" data-aos-delay="650">
                        <!-- Image Box -->
                        <a href="listing-details.html" class="img-box no-mb sin hover-effect">
                            <img src="images/popular-places/5.jpg" class="img-responsive" alt="">
                            <div class="img-box-content visible">
                                <h4 class="mb-2">Houston </h4>
                                <span>309 Properties</span>
                                <ul class="starts text-center mt-2">
                                    <li><i class="fa fa-star"></i>
                                    </li>
                                    <li><i class="fa fa-star"></i>
        ...
        <section class="request info-help" id="quote">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 col-md-12" data-aos="fade-right" data-aos-delay="150">
                    ...
                    <div class="col-lg-5 col-md-12 bgc" data-aos="fade-left" data-aos-delay="150">
                        <div class="call-info">
            ...
            <div class="container-fluid">
                ...
                <div class="row team-all">
                    ...
                    <div class="team-block col-sm-6 col-md-4 col-lg-4 col-xl-2 team-pro no-mb sin" data-aos="fade-up" data-aos-delay="550">
                        <div class="team-wrap">
                            <div class="team-img">
                                <img src="images/team/team-image-2.jpg" alt="" />
                            </div>
                            <div class="team-content">
                                <div class="team-info">
                                    <h3>Katy Grace</h3>
                    ...
                    <div class="team-block col-sm-6 col-md-4 col-lg-4 col-xl-2 team-pro no-mb" data-aos="fade-up" data-aos-delay="650">
                        <div class="team-wrap">
                            <div class="team-img">
                                <img src="images/team/team-image-7.jpg" alt="" />
                            </div>
                            <div class="team-content">
                                <div class="team-info">
                                    <h3>Katy Grace</h3>
