...
<!-- Mirrored from code-theme.com/html/findhouses/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Aug 2023 05:49:21 GMT -->
<head>
    <meta charset="UTF-8">
            ...
            <div id="header" class="head-tr bottom">
                <div class="container container-header">
                    ...
                    <div class="left-side">
                        <!-- Logo -->
                        <div id="logo">
                            <a href="{{ Route('index') }}"><img src="images/logo-white-1.svg" data-sticky-logo="images/logo-red.svg" alt=""></a>
                        </div>
                        <!-- Mobile Navigation -->
                                ...
                                <li><a href="#">Home</a>
                                    ...
                                    <li><a href="#">Property</a>
                                        <ul>
                                            ...
                                            <li><a href="properties-grid-3.html">Single Property 3</a></li>
                                            <li><a href="properties-grid-4.html">Single Property 4</a></li>
                                            <li><a href="properties-grid-5.html">Single Property 5</a></li>
                                            <li><a href="properties-grid-6.html">Single Property 6</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#">Pages</a>
                                        <ul>
                    ...
                    <div class="item col-xl-6 col-lg-12 col-md-12 col-xs-12 landscapes sale">
                        <div class="project-single" data-aos="fade-right">
                            ...
                            <div class="homes-content">
                                <!-- homes address -->
                                <h3><a href="{{Route('properties-grid')}}">Real Luxury Family House Villa</a></h3>
                                ...
                                <div class="price-properties footer pt-3 pb-0">
                                    <h3 class="title mt-3">
                                     <a href="{{Route('properties-grid')}}">$ 150,000</a>
                                    </h3>
                                    <div class="compare">
...
<!-- Mirrored from code-theme.com/html/findhouses/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Aug 2023 05:50:39 GMT -->
</html>
