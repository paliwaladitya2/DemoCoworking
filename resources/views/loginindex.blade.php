...
<!-- Mirrored from code-theme.com/html/findhouses/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Aug 2023 05:52:49 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <div id="wrapper">
        ...
        <section class="headings">
            <div class="text-heading text-center">
                <div class="container">
                    <h1>Login</h1>
                    <h2><a href="{{ Route('index') }}">Home </a> &nbsp;/&nbsp; login</h2>
                </div>
            </div>
        </section>
