...
<!-- Mirrored from code-theme.com/html/findhouses/index-13.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Aug 2023 05:52:17 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="int_dark_bg">
    ...
    <div id="wrapper" class="int_main_wraapper">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="swiper_contbox">
                                                    <div class="swipper_conntent">
                                                        <img src="images/slider/slider-8.jpg" class="img-fluid " alt="images" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="swiper_contbox">
                                                    <div class="swipper_conntent">
                                                        <img src="images/slider/slider-9.jpg" class="img-fluid" alt="images" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <section class="pricing-table rec-pro bg-black-1">
            <div class="container-fluid">
                <div class="section-title">
                    <h3>Pricing</h3>
                    <h2>Packages</h2>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="netabout">
                                <a href="index-2.html" class="logo">
                                    <img src="images/logo-white.svg" alt="netcom">
                                </a>
...
<!-- Mirrored from code-theme.com/html/findhouses/index-13.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Aug 2023 05:52:19 GMT -->
</html>
