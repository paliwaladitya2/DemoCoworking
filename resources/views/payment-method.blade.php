...
<!-- Mirrored from code-theme.com/html/findhouses/{{Route('payment-method')}} by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Aug 2023 05:52:46 GMT -->
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="user-profile-box mb-0">
                            ...
                            <div class="detail clearfix">
                                <ul class="mb-0">
                                    ...
                                    <li>
                                        <a class="active" href="{{Route('payment-method')}}">
