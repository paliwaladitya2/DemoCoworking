...
<!-- Mirrored from code-theme.com/html/findhouses/index-8.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Aug 2023 05:51:43 GMT -->
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="col-lg-5 col-sm-12" data-aos="fade-left">
                        ...
                        <div class="trip-search contact-us">
                            ...
                            <form id="contactform" class="contact-form" name="contactform" method="post" novalidate>
                                ...
                                <div class="form-group">
                                    <input type="text" required class="form-control input-custom input-full" name="phonenumber" placeholder="Your Phone">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control input-custom input-full" name="email" placeholder="Your Email">
                                </div>
                                <div class="form-group">
                                    <textarea class="form-control textarea-custom input-full" id="ccomment" name="message" required rows="8" placeholder="Type Your Message..."></textarea>
                                </div>
